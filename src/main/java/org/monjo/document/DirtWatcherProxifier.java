...
public class DirtWatcherProxifier {
	...
	private static final Set<Method> INTERNAL_METHODS = new HashSet<Method>(Arrays.asList(InternalMonjoObject.class.getDeclaredMethods()));
	...
	public static <T> T proxify(final T pojo) {
		...
		enhancer.setInterfaces(new Class[] { InternalMonjoObject.class });
	...
	private static class BaseObject implements InternalMonjoObject {
